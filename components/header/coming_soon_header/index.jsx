...
const Header1 = () => {
  ...
  useEffect(() => {
    TagManager.initialize({gtmId: 'GTM-KNP4MCL5' });
  }, []);
  ...
  return (
    <>
      <header className={`header ${navbar ? "is-sticky" : ""}`} >
        <div className="header__container px-90 sm:px-30 ">
          <div className="row justify-between items-center ml-90 mt-60">
            <div className="col-auto">
              <div className="d-flex items-center ml-90 mt-90 ">
                ...
                <div className="header-menu">
                  <div className="header-menu__content px-90 ml-90">

                    {/* <MainMenu style="text-dark-1"/> */}

                  <Link href="/" className="header-logo  ml-90">
                  <img src="/img/general/HaloUK.png" alt="logo icon" />
