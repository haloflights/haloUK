...
import { all_inclusive_turkey_city_hotels } from "../../../../../data/city_hotels";

const IzmirHotel = () => {
  return (
    <>
      {all_inclusive_turkey_city_hotels.filter((item) => item.city === 'izmir_area').map((item) => (
