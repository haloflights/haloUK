...
import { all_inclusive_phuket_city_hotels } from "../../../../../data/city_hotels";

const PatongHotel = () => {
  return (
    <>
      {all_inclusive_phuket_city_hotels.filter((item) => item.city === 'patong_beach').map((item) => (
