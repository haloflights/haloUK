...
import { all_inclusive_spain_city_hotels } from "../../../../../data/city_hotels";

const AndaluciaHotel = () => {
  return (
    <>
      {all_inclusive_spain_city_hotels.filter((item) => item.city === 'andalucia').map((item) => (
