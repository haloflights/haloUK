...
const Couple_HotelProperties = () => {
  return (
    <>
      {all_inclusive_maldives_city_hotels.filter((item) => item.city === 'couples_adults_only').map((item) => (
...
export default Couple_HotelProperties;
