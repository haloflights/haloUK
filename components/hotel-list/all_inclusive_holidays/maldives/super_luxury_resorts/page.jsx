...
import { all_inclusive_maldives_city_hotels } from "../../../../../data/city_hotels";

const SuperLuxury_HotelProperties = () => {
  return (
    <>
      {all_inclusive_maldives_city_hotels.filter((item) => item.city === 'super_luxury_resorts').map((item) => (
...
export default SuperLuxury_HotelProperties;
