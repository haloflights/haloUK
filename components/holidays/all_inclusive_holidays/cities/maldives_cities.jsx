...
import { all_inclusive_maldives_destinations } from "@/data/cities";
import Link from "next/link";

const maldives_cities = () => {
  return (
    <div className="pt-40 overflow-hidden js-section-slider">
      ...
      >
        {all_inclusive_maldives_destinations.map((item) => (
...
export default maldives_cities;
