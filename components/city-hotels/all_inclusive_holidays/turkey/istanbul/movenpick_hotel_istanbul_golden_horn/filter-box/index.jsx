...
const HighlightList = ({ holiday }) => {
  ...
  return (
    ...
    <li >10 mins from Old City</li>
    <li >Breath-taking views of the Golden Horn shore</li>
    <li >Golden Horn, the Historical Zone, Pierre Loti and Sultanahmet are in a-few-minutes drive and walk distance</li>
</ul>
        {/* End Location */}
