...
const HighlightList = ({ holiday }) => {
  ...
  return (
    ...
    <li >5 Nights</li>
    <li >Room Only</li>
    <li >Room service available for 24 hours</li>
    <li >İstinye Park mall is 10 minutes away via free shuttle</li>
    <li >Include breakfast for a price of £12 per person per night</li>
</ul>
        {/* End Location */}
