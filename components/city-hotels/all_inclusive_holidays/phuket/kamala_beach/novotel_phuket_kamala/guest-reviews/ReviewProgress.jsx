...
const ReviewProgress = ({ holiday }) => {
  const reviewProgressContent = [
    { id: 1, reviewReason: "Staff", ratings: "8.6", progressPercent: "86%" },
    { id: 2, reviewReason: "Facilities", ratings: "7.9", progressPercent: "79%" },
    { id: 3, reviewReason: "Cleanliness", ratings: "8.2", progressPercent: "82%" },
    { id: 4, reviewReason: "Comfort", ratings: "8.2", progressPercent: "82%" },
