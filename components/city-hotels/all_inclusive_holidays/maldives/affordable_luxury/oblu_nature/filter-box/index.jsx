...
const HighlightList = ({ holiday }) => {
  ...
  return (
    ...
    <li >Experience Oblu Island All inclusive plan</li>
    <li >Environment Sustainability</li>
    <li >Complimetary upgrade to Lagoon Villa with pool</li>
    <li >DELICIOUS WORLD CUISINE AND MALDIVIAN FAVOURITES</li>
</ul>
        {/* End Location */}
