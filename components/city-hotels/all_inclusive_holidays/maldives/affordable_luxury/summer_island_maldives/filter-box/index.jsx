...
const HighlightList = ({ holiday }) => {
  ...
  return (
    ...
    <li >SPARKLE ON THE SANDBANK</li>
    <li >SUNDOWN SAILBOAT</li>
    <li >SAND AND STARS DINNER</li>
    <li >Under water Love Locks</li>
    <li >Overwater Bar</li>
    <li >Complimentary upgrade to Overwater Villa</li>
</ul>
        {/* End Location */}
