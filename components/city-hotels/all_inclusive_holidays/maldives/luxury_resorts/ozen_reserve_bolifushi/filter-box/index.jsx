...
const HighlightList = ({ holiday }) => {
  ...
  return (
    ...
    <li >Selection of exclusive champagnes (3 premium brands) and sparkling wines</li>
    <li >Exclusive dining experience in signature restuarent</li>
    <li >Complementary non - motorized water</li>
    <li >Enjoy a traditional Maldivian welcome, as you step onto Bolifushi island. The blowing of a conch shell accompanies the placing of a hand-crafted palm leaf necklace, with rhythmic ‘bodu beru’ drumming</li>
</ul>
        {/* End Location */}
