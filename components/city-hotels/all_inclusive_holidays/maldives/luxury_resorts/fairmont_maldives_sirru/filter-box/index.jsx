...
const HighlightList = ({ holiday }) => {
  ...
  return (
    ...
    <li >Daily buffet breakfast, lunch, and dinner at Raha Market</li>
    <li >Special 3-Course dinner at Kata & Azure</li>
    <li >Use of snorkeling gears and non–motorized water sports activities</li>
    <li >Tour of the Sustainability Lab and underwater Coralarium once during the stay</li>
</ul>
        {/* End Location */}
