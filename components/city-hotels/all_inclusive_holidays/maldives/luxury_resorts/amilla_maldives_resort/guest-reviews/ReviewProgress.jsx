...
const ReviewProgress = ({ holiday }) => {
  const reviewProgressContent = [
    { id: 1, reviewReason: "Staff", ratings: "9.9", progressPercent: "99%" },
    ...
    { id: 5, reviewReason: "Value for money", ratings: "9.3", progressPercent: "93%" },
    { id: 6, reviewReason: "Location", ratings: "9.8", progressPercent: "98%" },
