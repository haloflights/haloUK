...
const HighlightList = ({ holiday }) => {
  ...
  return (
    ...
    <li >Culinary delights high-quality</li>
    <li >Free Wifi</li>
    <li >Sports variety entertainment and inspiration exciting regional discoveries</li>
    <li >Drinks included: Coffee specialities for breakfast, all drinks at the bar all day long </li>
</ul>
        {/* End Location */}
