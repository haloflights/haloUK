...
const HighlightList = ({ holiday }) => {
  ...
  return (
    ...
    <li >H2O by Berton, a pioneering underwater restaurant in the Maldives</li>
    <li >One Sunset Dolphin Cruise</li>
    <li >Unlimited “all you can drink” alcoholic and non-alcoholic beverages</li>
    <li >One demi bottle of Champagne served in villa on arrival, per villa, per length of stay</li>
</ul>
        {/* End Location */}
