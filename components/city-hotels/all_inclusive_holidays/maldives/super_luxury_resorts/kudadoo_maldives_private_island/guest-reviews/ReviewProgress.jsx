...
const ReviewProgress = ({ holiday }) => {
  const reviewProgressContent = [
    { id: 1, reviewReason: "Staff", ratings: "10", progressPercent: "100%" },
    { id: 2, reviewReason: "Facilities", ratings: "9.9", progressPercent: "99%" },
    { id: 3, reviewReason: "Cleanliness", ratings: "9.9", progressPercent: "99%" },
    { id: 4, reviewReason: "Comfort", ratings: "9.9", progressPercent: "99%" },
    { id: 5, reviewReason: "Value for money", ratings: "9.5", progressPercent: "95%" },
    { id: 6, reviewReason: "Location", ratings: "97", progressPercent: "97%" },
  ];
