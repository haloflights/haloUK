...
const ReviewProgress = ({ holiday }) => {
  const reviewProgressContent = [
    ...
    { id: 3, reviewReason: "Cleanliness", ratings: "8.1", progressPercent: "81%" },
    { id: 4, reviewReason: "Comfort", ratings: "8.1", progressPercent: "81%" },
    { id: 5, reviewReason: "Value for money", ratings: "8.1", progressPercent: "81%" },
    { id: 6, reviewReason: "Location", ratings: "8.7", progressPercent: "87%" },
