...
const ReviewProgress = ({ holiday }) => {
  const reviewProgressContent = [
    { id: 1, reviewReason: "Staff", ratings: "9.4", progressPercent: "94%" },
    { id: 2, reviewReason: "Facilities", ratings: "9.0", progressPercent: "90%" },
    { id: 3, reviewReason: "Cleanliness", ratings: "9.3", progressPercent: "93%" },
    { id: 4, reviewReason: "Comfort", ratings: "9.3", progressPercent: "93%" },
    { id: 5, reviewReason: "Value for money", ratings: "8.8", progressPercent: "88%" },
    { id: 6, reviewReason: "Location", ratings: "9.7", progressPercent: "97%" },
    { id: 7, reviewReason: "Free WiFi", ratings: "9.0", progressPercent: "90%" },
  ];
