...
const ReviewProgress = ({ holiday }) => {
  const reviewProgressContent = [
    ...
    { id: 2, reviewReason: "Facilities", ratings: "8.0", progressPercent: "80%" },
    { id: 3, reviewReason: "Cleanliness", ratings: "8.5", progressPercent: "85%" },
    { id: 4, reviewReason: "Comfort", ratings: "7.5", progressPercent: "75%" },
    ...
    { id: 7, reviewReason: "Free WiFi", ratings: "7.0", progressPercent: "70%" },
  ];
