...
const ReviewProgress = ({ holiday }) => {
  const reviewProgressContent = [
    { id: 1, reviewReason: "Staff", ratings: "8.8", progressPercent: "88%" },
    { id: 2, reviewReason: "Facilities", ratings: "8.1", progressPercent: "81%" },
    { id: 3, reviewReason: "Cleanliness", ratings: "8.2", progressPercent: "82%" },
    { id: 4, reviewReason: "Comfort", ratings: "8.3", progressPercent: "83%" },
    { id: 5, reviewReason: "Value for money", ratings: "8.1", progressPercent: "81%" },
    { id: 6, reviewReason: "Location", ratings: "7.7", progressPercent: "77%" },
    { id: 7, reviewReason: "Free WiFi", ratings: "8.6", progressPercent: "86%" },
  ];
