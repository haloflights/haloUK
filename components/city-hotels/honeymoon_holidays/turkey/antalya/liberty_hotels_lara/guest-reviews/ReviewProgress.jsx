...
const ReviewProgress = ({ holiday }) => {
  const reviewProgressContent = [
    ...
    { id: 2, reviewReason: "Facilities", ratings: "8.9", progressPercent: "89%" },
    { id: 3, reviewReason: "Cleanliness", ratings: "9.0", progressPercent: "90%" },
    { id: 4, reviewReason: "Comfort", ratings: "9.0", progressPercent: "90%" },
    ...
    { id: 7, reviewReason: "Free WiFi", ratings: "9.1", progressPercent: "91%" },
  ];
