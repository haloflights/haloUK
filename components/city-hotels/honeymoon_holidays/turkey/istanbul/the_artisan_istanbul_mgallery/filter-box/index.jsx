...
const HighlightList = ({ holiday }) => {
  ...
  return (
    ...
    <li >Connected rooms for families</li>
    <li >Few meters from Taksim metro and a 10-minute walk from Kabataş port</li>
    <li >Breakfast and Dinner possibility at the rooftop restaurant with Panoramic Bosphorus View</li>
</ul>
        {/* End Location */}
