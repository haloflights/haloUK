...
const ReviewProgress = ({ holiday }) => {
  const reviewProgressContent = [
    { id: 1, reviewReason: "Staff", ratings: "8.5", progressPercent: "85%" },
    { id: 2, reviewReason: "Facilities", ratings: "7.7", progressPercent: "77%" },
    { id: 3, reviewReason: "Cleanliness", ratings: "7.9", progressPercent: "79%" },
    { id: 4, reviewReason: "Comfort", ratings: "7.7", progressPercent: "77%" },
    { id: 5, reviewReason: "Value for money", ratings: "8.2", progressPercent: "82%" },
    { id: 6, reviewReason: "Location", ratings: "7.5", progressPercent: "75%" },
    { id: 7, reviewReason: "Free WiFi", ratings: "5.8", progressPercent: "58%" },
  ];
