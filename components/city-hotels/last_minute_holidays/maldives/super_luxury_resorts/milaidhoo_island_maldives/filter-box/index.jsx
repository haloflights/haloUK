    ...
    <>
      <div className="col-12 pb-20 ">
        <ul className="list list--bullet">
          <li >Complimentary upgrade to water villa with private pool</li>
          <li >Experience the Milaidhoo Gourmet Plan All-Inclusive</li>
          <li >Seaplane and speedboat transfers</li>
          <li >Exclusive for Honeymoon & Babymoon</li>
        </ul>
        {/* End Location */}
