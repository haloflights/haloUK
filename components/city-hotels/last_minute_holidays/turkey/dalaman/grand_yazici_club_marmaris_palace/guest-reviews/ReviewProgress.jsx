...
const ReviewProgress = ({ holiday }) => {
  const reviewProgressContent = [
    { id: 1, reviewReason: "Staff", ratings: "7.5", progressPercent: "75%" },
    { id: 2, reviewReason: "Facilities", ratings: "7.2", progressPercent: "72%" },
    { id: 3, reviewReason: "Cleanliness", ratings: "6.9", progressPercent: "69%" },
    { id: 4, reviewReason: "Comfort", ratings: "6.8", progressPercent: "68%" },
    { id: 5, reviewReason: "Value for money", ratings: "6.9", progressPercent: "69%" },
    { id: 6, reviewReason: "Location", ratings: "8.4", progressPercent: "84%" },
    { id: 7, reviewReason: "Free WiFi", ratings: "2.5", progressPercent: "25%" },
  ];
