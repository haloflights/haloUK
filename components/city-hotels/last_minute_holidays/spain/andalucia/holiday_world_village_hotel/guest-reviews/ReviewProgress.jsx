...
const ReviewProgress = ({ holiday }) => {
  const reviewProgressContent = [
    ...
    { id: 2, reviewReason: "Facilities", ratings: "8.5", progressPercent: "83%" },
    { id: 3, reviewReason: "Cleanliness", ratings: "8.3", progressPercent: "83%" },
    { id: 4, reviewReason: "Comfort", ratings: "8.5", progressPercent: "85%" },
    { id: 5, reviewReason: "Value for money", ratings: "8.0", progressPercent: "80%" },
    { id: 6, reviewReason: "Location", ratings: "8.0", progressPercent: "80%" },
    { id: 7, reviewReason: "Free WiFi", ratings: "6.5", progressPercent: "65%" },
  ];
