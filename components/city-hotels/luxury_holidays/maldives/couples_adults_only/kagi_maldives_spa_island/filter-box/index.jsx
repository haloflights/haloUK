...
const HighlightList = ({ holiday }) => {
  ...
  return (
    ...
    <li >Unlimited alcoholic and non-alcoholic beverages</li>
    <li >Exclusive discount of 20% on selected Spa treatments and wellness packages</li>
    <li >Complimentary snorkeling equipment during the stay</li>
    <li >One Sunset Dolphin Cruise Group Excursion</li>
</ul>
        {/* End Location */}
