    ...
    <>
      <div className="col-12 pb-20 ">
        <ul class="list list--bullet">
          <li >5.8 Undersea Restaurant</li>
          <li >Daily buffet lunch and buffet dinner in the Canneli Restaurant</li>
          <li >10% discount for a la carte food menus (except 5.8 Undersea Restaurant)</li>
          <li >Unlimited “all you can drink” alcoholic and non-alcoholic beverages “all day - all night”</li>
          <li >Honeymoon Package</li>
          <li >Celebrate a Renewal of Vows or Wedding Ceremony at the beach Wedding Pavilion.</li>
        </ul>
        {/* End Location */}
