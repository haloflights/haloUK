    ...
    <>
      <div className="col-12 pb-20 ">
        <ul class="list list--bullet">
          <li >100 Villas, from one to three bedroom accommodation</li>
          <li >24 Hours ‘Aris Meeha’, butler service for every villa</li>
          <li >7 Restaurants and Bars</li>
          <li >Jean-Michel Cousteau’s Ambassadors of the Environment program</li>
          <li >The Ritz-Carlton Spa, offering 9 treatment rooms and a Spa Suite, with lavish Bamford amenities </li>
        </ul>
        {/* End Location */}
