...
const HighlightList = ({ holiday }) => {
  ...
  return (
    ...
    <li >Soneva Unlimited at Soneva Secret 2024</li>
    <li >Castaway Picnic</li>
    <li >Diving at Soneva Kiri</li>
    <li >Private Cinema Paradiso​</li>
    <li >eFoil, eSurf & Seabob</li>
    <li >Seven Days, Seven Beaches</li>
</ul>
        {/* End Location */}
