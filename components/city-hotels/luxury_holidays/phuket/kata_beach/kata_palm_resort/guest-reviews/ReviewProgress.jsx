...
const ReviewProgress = ({ holiday }) => {
  const reviewProgressContent = [
    ...
    { id: 2, reviewReason: "Facilities", ratings: "7.8", progressPercent: "78%" },
    { id: 3, reviewReason: "Cleanliness", ratings: "7.9", progressPercent: "79%" },
    { id: 4, reviewReason: "Comfort", ratings: "8.0", progressPercent: "80%" },
    ...
    { id: 7, reviewReason: "Free WiFi", ratings: "8.7", progressPercent: "87%" },
  ];
