...
const HighlightList = ({ holiday }) => {
  ...
  return (
    ...
    <li >Selection of 70 types of wines</li>
    <li >Includes Buffet Breakfast</li>
    <li >Unlimited Premium Alcoholic Beverages</li>
    <li >Complimentary snorkelling equipment</li>
    <li >Complimentary access to the Floating Aqua Park</li>
    <li >Two excursions per person per stay to choose from Dolphin Cruise & Guided House Reef Snorkelling</li>
</ul>
        {/* End Location */}
