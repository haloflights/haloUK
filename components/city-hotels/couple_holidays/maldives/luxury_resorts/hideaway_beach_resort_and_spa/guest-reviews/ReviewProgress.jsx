...
const ReviewProgress = ({ holiday }) => {
  const reviewProgressContent = [
    ...
    { id: 2, reviewReason: "Facilities", ratings: "9.1", progressPercent: "91%" },
    { id: 3, reviewReason: "Cleanliness", ratings: "9.2", progressPercent: "92%" },
    { id: 4, reviewReason: "Comfort", ratings: "9.1", progressPercent: "91%" },
    { id: 5, reviewReason: "Value for money", ratings: "8.4", progressPercent: "84%" },
    { id: 6, reviewReason: "Location", ratings: "8.6", progressPercent: "86%" },
    { id: 7, reviewReason: "Free WiFi", ratings: "8.3", progressPercent: "83%" },
  ];
