...
const ReviewProgress = ({ holiday }) => {
  const reviewProgressContent = [
    ...
    { id: 2, reviewReason: "Facilities", ratings: "6.9", progressPercent: "69%" },
    { id: 3, reviewReason: "Cleanliness", ratings: "7.2", progressPercent: "72%" },
    { id: 4, reviewReason: "Comfort", ratings: "7.1", progressPercent: "71%" },
