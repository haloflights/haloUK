...
const HighlightList = ({ holiday }) => {
  ...
  return (
    ...
    <li >5 Nights</li>
    <li >Provides ultra All Inclusive Meal Plans</li>
    <li >Situated in Turgutreis one of the finest places areas of Bodrum</li>
    <li >They got activities throughout the year, doesn't matter if it's off season or not</li>
</ul>
        {/* End Location */}
