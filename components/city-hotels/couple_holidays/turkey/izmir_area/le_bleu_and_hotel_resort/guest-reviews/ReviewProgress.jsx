...
const ReviewProgress = ({ holiday }) => {
  const reviewProgressContent = [
    { id: 1, reviewReason: "Staff", ratings: "8.1", progressPercent: "81%" },
    { id: 2, reviewReason: "Facilities", ratings: "7.4", progressPercent: "74%" },
    { id: 3, reviewReason: "Cleanliness", ratings: "7.7", progressPercent: "77%" },
    { id: 4, reviewReason: "Comfort", ratings: "7.7", progressPercent: "77%" },
    { id: 5, reviewReason: "Value for money", ratings: "7.4", progressPercent: "74%" },
    { id: 6, reviewReason: "Location", ratings: "8.5", progressPercent: "85%" },
    { id: 7, reviewReason: "Free WiFi", ratings: "6.4", progressPercent: "64%" },
  ];
