...
const ReviewProgress = ({ holiday }) => {
  const reviewProgressContent = [
    { id: 1, reviewReason: "Staff", ratings: "8.4", progressPercent: "84%" },
    { id: 2, reviewReason: "Facilities", ratings: "8.4", progressPercent: "84%" },
    { id: 3, reviewReason: "Cleanliness", ratings: "8.2", progressPercent: "82%" },
    { id: 4, reviewReason: "Comfort", ratings: "8.3", progressPercent: "83%" },
    { id: 5, reviewReason: "Value for money", ratings: "7.7", progressPercent: "77%" },
