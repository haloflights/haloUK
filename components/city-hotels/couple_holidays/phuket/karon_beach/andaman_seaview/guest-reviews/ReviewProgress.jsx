...
const ReviewProgress = ({ holiday }) => {
  const reviewProgressContent = [
    ...
    { id: 2, reviewReason: "Facilities", ratings: "7.1", progressPercent: "71%" },
    { id: 3, reviewReason: "Cleanliness", ratings: "7.6", progressPercent: "76%" },
    { id: 4, reviewReason: "Comfort", ratings: "7.6", progressPercent: "76%" },
    { id: 5, reviewReason: "Value for money", ratings: "7.4", progressPercent: "74%" },
    { id: 6, reviewReason: "Location", ratings: "9.0", progressPercent: "90%" },
    { id: 7, reviewReason: "Free WiFi", ratings: "6.9", progressPercent: "69%" },
  ];
