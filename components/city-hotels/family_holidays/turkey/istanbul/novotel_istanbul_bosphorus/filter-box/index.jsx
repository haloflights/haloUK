...
const HighlightList = ({ holiday }) => {
  ...
  return (
    ...
    <li >Free amenities</li>
    <li >Suites with Free WIFI</li>
    <li >Free indoor parking</li>
    <li >Contemporary designed 200 guest rooms</li>
    <li >Perfect for culture,shopping , dining & night</li>
    <li >Walking distance to Sultanahmet, Galata & Pera</li>
    <li >Suites available with impressive view over the Bosphorus</li>
</ul>
        {/* End Location */}
