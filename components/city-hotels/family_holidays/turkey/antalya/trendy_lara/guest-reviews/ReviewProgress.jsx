...
const ReviewProgress = ({ holiday }) => {
  const reviewProgressContent = [
    ...
    { id: 2, reviewReason: "Facilities", ratings: "8.8", progressPercent: "88%" },
    { id: 3, reviewReason: "Cleanliness", ratings: "8.7", progressPercent: "87%" },
    { id: 4, reviewReason: "Comfort", ratings: "8.9", progressPercent: "89%" },
    { id: 5, reviewReason: "Value for money", ratings: "8.2", progressPercent: "82%" },
    { id: 6, reviewReason: "Location", ratings: "7.8", progressPercent: "78%" },
