...
const HighlightList = ({ holiday }) => {
  ...
  return (
    ...
    <li >5 Nights</li>
    <li >10 Pools</li>
    <li >5 Water Slides</li>
    <li >Lagoon Plus - Private Service</li>
    <li >A 16+ Relaxation Pool Just for the Adults</li>
    <li >Can Book a Romantic Dinner in the Speciality Restaurant</li>
</ul>
        {/* End Location */}
