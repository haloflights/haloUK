...
const HighlightList = ({ holiday }) => {
  ...
  return (
    ...
    <li >5 Nights</li>
    <li >3 Outdoor pools</li>
    <li >10 Waterslides</li>
    <li >7 Restaurants</li>
    <li >Resort is surrounded by the beach</li>
    <li >One of the Most Popular Hotels Worldwide</li>
    <li >Got Awards for Quality Management (2022)</li>
</ul>
        {/* End Location */}
