...
const HighlightList = ({ holiday }) => {
  ...
  return (
    ...
    <li >5 Nights</li>
    <li >Entry to Aqua Fantasy Aqua Park Included</li>
    <li >On-site wave pool - 30 slides, wave pool, and a lazy river</li>
    <li >Awarded Best Splash Hotel for 5 consecutive years</li>
</ul>
        {/* End Location */}
