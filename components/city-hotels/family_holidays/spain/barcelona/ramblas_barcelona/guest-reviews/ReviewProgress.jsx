...
const ReviewProgress = ({ holiday }) => {
  const reviewProgressContent = [
    { id: 1, reviewReason: "Staff", ratings: "8.2", progressPercent: "82%" },
    ...
    { id: 5, reviewReason: "Value for money", ratings: "7.5", progressPercent: "75%" },
    { id: 6, reviewReason: "Location", ratings: "9.3", progressPercent: "93%" },
    { id: 7, reviewReason: "Free WiFi", ratings: "7.7", progressPercent: "77%" },
  ];
