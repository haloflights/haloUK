...
const ReviewProgress = ({ holiday }) => {
  const reviewProgressContent = [
    ...
    { id: 2, reviewReason: "Facilities", ratings: "9.5", progressPercent: "95%" },
    { id: 3, reviewReason: "Cleanliness", ratings: "9.9", progressPercent: "99%" },
    { id: 4, reviewReason: "Comfort", ratings: "9.8", progressPercent: "98%" },
    { id: 5, reviewReason: "Value for money", ratings: "8.6", progressPercent: "86%" },
    { id: 6, reviewReason: "Location", ratings: "9.6", progressPercent: "96%" },
