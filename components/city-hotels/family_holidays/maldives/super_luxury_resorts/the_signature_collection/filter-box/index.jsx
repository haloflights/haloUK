    ...
    <>
      <div className="col-12 pb-20 ">
        <ul class="list list--bullet">
          <li >Complimentary Wi-Fi in the villas and public areas</li>
          <li >Unlimited “all you can drink” alcoholic and non-alcoholic beverages “all day - all night”</li>
          <li >Complimentary use of snorkeling equipment which can be collected from the Dive Center (08:00 to 18:00) during your stay.</li>
          <li >Complimentary two excursions per person per stay, Sunset Dolphin Safari and Guided House Reef Snorkeling</li>
        </ul>
        {/* End Location */}
