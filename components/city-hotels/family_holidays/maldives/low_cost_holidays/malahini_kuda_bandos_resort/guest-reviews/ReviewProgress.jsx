...
const ReviewProgress = ({ holiday }) => {
  const reviewProgressContent = [
    ...
    { id: 2, reviewReason: "Facilities", ratings: "8.3", progressPercent: "83%" },
    ...
    { id: 6, reviewReason: "Location", ratings: "8.8", progressPercent: "88%" },
    { id: 7, reviewReason: "Free WiFi", ratings: "6.6", progressPercent: "66%" },
  ];
