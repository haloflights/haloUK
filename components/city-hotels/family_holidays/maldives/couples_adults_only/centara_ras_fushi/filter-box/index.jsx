...
const HighlightList = ({ holiday }) => {
  ...
  return (
    ...
    <li >Free Wi-Fi</li>
    <li >Free access to all 4 bars in the resort, including ALL beverages</li>
    <li >10% discount on SPA Cenvaree (excluding spa retail products)</li>
    <li >Free inclusion of water sports: Non-Motorized, Snorkelling Gear</li>
</ul>
        {/* End Location */}
