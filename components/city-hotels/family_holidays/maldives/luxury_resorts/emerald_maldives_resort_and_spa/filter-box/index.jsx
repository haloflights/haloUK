...
const HighlightList = ({ holiday }) => {
  ...
  return (
    ...
    <li >Complementary high speed WIFI</li>
    <li >Complementary water sports</li>
    <li >Unlimited acess to cocktail and & signature drinks menu</li>
    <li >Bodu Beru' maldivian signature dance performance every evening once per week</li>
    <li >Large variety of super premuim brabded spirits and international beers</li>
</ul>
        {/* End Location */}
