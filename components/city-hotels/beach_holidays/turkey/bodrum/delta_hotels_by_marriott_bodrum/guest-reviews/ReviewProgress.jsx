...
const ReviewProgress = ({ holiday }) => {
  const reviewProgressContent = [
    { id: 1, reviewReason: "Staff", ratings: "7.0", progressPercent: "70%" },
    { id: 2, reviewReason: "Facilities", ratings: "7.2", progressPercent: "72%" },
    { id: 3, reviewReason: "Cleanliness", ratings: "6.8", progressPercent: "68%" },
    { id: 4, reviewReason: "Comfort", ratings: "7.0", progressPercent: "70%" },
    { id: 5, reviewReason: "Value for money", ratings: "6.3", progressPercent: "63%" },
    { id: 6, reviewReason: "Location", ratings: "8.2", progressPercent: "82%" },
    { id: 7, reviewReason: "Free WiFi", ratings: "9.4", progressPercent: "94%" },
  ];
