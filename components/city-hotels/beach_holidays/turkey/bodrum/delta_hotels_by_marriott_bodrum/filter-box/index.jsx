...
const HighlightList = ({ holiday }) => {
  ...
  return (
    ...
    <li >Got One of the best locations in Yalikavak - Located at the Beach</li>
    <li >Free Meal at a Ala Carte Restaurant if you stay for every 4-6 nights stay in the Resort</li>
</ul>
        {/* End Location */}
