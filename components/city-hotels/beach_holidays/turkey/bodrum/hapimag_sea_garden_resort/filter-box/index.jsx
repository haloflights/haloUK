...
const HighlightList = ({ holiday }) => {
  ...
  return (
    ...
    <li >5 Nights</li>
    <li >Located by the Beach itself</li>
    <li >3 Kids Clubs - aged 4 to 15 (Perfect for Families)</li>
    <li >Got 6 Restaurants (1 Open Buffet and 5 Ala Carte) - Ala Carte Restaurants are available only for passengers staying more than 7 nights</li>
</ul>
        {/* End Location */}
