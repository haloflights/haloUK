...
const HighlightList = ({ holiday }) => {
  ...
  return (
    ...
    <li >5 Nights</li>
    <li >Seafront Resort</li>
    <li >Kusadasi city centre is 3 km away</li>
    <li >Only guests, who stays for at least more than 7 days, can benefit from À la carte restaurant for free for once by reserving in advance</li>
</ul>
        {/* End Location */}
