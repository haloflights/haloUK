...
const ReviewProgress = ({ holiday }) => {
  const reviewProgressContent = [
    { id: 1, reviewReason: "Staff", ratings: "9.5", progressPercent: "95%" },
    ...
    { id: 5, reviewReason: "Value for money", ratings: "8.9", progressPercent: "89%" },
    { id: 6, reviewReason: "Location", ratings: "8.2", progressPercent: "82%" },
    { id: 7, reviewReason: "Free WiFi", ratings: "8.1", progressPercent: "81%" },
  ];
