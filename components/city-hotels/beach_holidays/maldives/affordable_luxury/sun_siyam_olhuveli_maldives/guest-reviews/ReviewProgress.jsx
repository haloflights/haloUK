...
const ReviewProgress = ({ holiday }) => {
  const reviewProgressContent = [
    ...
    { id: 2, reviewReason: "Facilities", ratings: "9.0", progressPercent: "90%" },
    { id: 3, reviewReason: "Cleanliness", ratings: "9.2", progressPercent: "92%" },
    { id: 4, reviewReason: "Comfort", ratings: "9.2", progressPercent: "92%" },
    { id: 5, reviewReason: "Value for money", ratings: "8.2", progressPercent: "82%" },
    { id: 6, reviewReason: "Location", ratings: "9.3", progressPercent: "93%" },
    { id: 7, reviewReason: "Free WiFi", ratings: "8.4", progressPercent: "84%" },
  ];
