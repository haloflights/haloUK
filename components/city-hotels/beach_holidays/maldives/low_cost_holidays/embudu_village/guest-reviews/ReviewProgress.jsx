...
const ReviewProgress = ({ holiday }) => {
  const reviewProgressContent = [
    { id: 1, reviewReason: "Staff", ratings: "8.9", progressPercent: "89%" },
    { id: 2, reviewReason: "Facilities", ratings: "8.2", progressPercent: "82%" },
    { id: 3, reviewReason: "Cleanliness", ratings: "8.7", progressPercent: "87%" },
    { id: 4, reviewReason: "Comfort", ratings: "8.7", progressPercent: "87%" },
    { id: 5, reviewReason: "Value for money", ratings: "8.5", progressPercent: "85%" },
    { id: 6, reviewReason: "Location", ratings: "9.2", progressPercent: "92%" },
    { id: 7, reviewReason: "Free WiFi", ratings: "7.9", progressPercent: "79%" },
  ];
