...
import Hotels from "@/components/hotels/common/phuket/LM_Phuket_Hotels";
...
import Maldives_cities from "@/components/holidays/last_minute_holidays/cities/phuket_cities";

export const metadata = {
  title: "Last Minute Holidays to Phuket | Halo Holidays",
  description: "Sun-kissed beaches await! Find last-minute Phuket holidays at amazing prices with Halo Holidays.",
};
      ...
      <section className="layout-pt-md layout-pb-md">
        <div className="container">
          <div className="row y-gap-20 justify-between items-end">
            <div className="col-auto">
              <div className="sectionTitle -md">
                <h2 className="sectionTitle__title">Last Minute Hotels in Phuket</h2>
                <p className=" sectionTitle__text mt-5 sm:mt-0">
