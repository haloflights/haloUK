...
import Hotels from "@/components/hotels/common/spain/LM_Spain_Hotels";
...
import Maldives_cities from "@/components/holidays/last_minute_holidays/cities/spain_cities";

export const metadata = {
  title: "Last Minute Holidays to Spain | Halo Holidays",
  description: "Need a spontaneous getaway? Discover incredible deals on last-minute holidays to Spain.",
};
      ...
      <section className="layout-pt-md layout-pb-md">
        <div className="container">
          <div className="row y-gap-20 justify-between items-end">
            <div className="col-auto">
              <div className="sectionTitle -md">
                <h2 className="sectionTitle__title">Last Minute Hotels in Spain</h2>
                <p className=" sectionTitle__text mt-5 sm:mt-0">
