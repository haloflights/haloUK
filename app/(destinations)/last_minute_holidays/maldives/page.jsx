...
import Hotels from "@/components/hotels/common/maldives/LM_M_Hotels";
...
import Maldives_cities from "@/components/holidays/last_minute_holidays/cities/maldives_cities";

export const metadata = {
  title: "Last Minute Holidays to Maldives | Halo Holidays",
  description: "Escape to paradise! Book your last-minute Maldives getaway with Halo Holidays today.",
};
      ...
      <section className="layout-pt-md layout-pb-md">
        <div className="container">
          <div className="row y-gap-20 justify-between items-end">
            <div className="col-auto">
              <div className="sectionTitle -md">
                <h2 className="sectionTitle__title">Last Minute Hotels in Maldives</h2>
                <p className=" sectionTitle__text mt-5 sm:mt-0">
