...
import Overview from "@/components/city-hotels/last_minute_holidays/maldives/exquisite_escapes/joy_island/Overview";
import TopBreadCrumb from "@/components/city-hotels/last_minute_holidays/maldives/exquisite_escapes/joy_island/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/last_minute_holidays/maldives/exquisite_escapes/joy_island/SidebarRight";
import ReviewProgress from "@/components/city-hotels/last_minute_holidays/maldives/exquisite_escapes/joy_island/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/last_minute_holidays/maldives/exquisite_escapes/joy_island/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/last_minute_holidays/maldives/exquisite_escapes/joy_island/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/last_minute_holidays/maldives/exquisite_escapes/joy_island/GalleryCruiseSlider";
...
export const metadata = {
  title: "Joy Island Maldives All Inclusive Package| Halo Holidays",
  description: "Unleash your inner child at Joy Island Maldives! Splashes in infinity pools, snorkeling adventures, and kids' club escapades - all included.",
};

const joy_island = () => {
  const title = "Joy Island Maldives";
...
export default dynamic(() => Promise.resolve(joy_island), {
  ssr: false,
});
