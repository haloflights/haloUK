...
import Overview from "@/components/city-hotels/last_minute_holidays/maldives/affordable_luxury/oblu_nature/Overview";
import TopBreadCrumb from "@/components/city-hotels/last_minute_holidays/maldives/affordable_luxury/oblu_nature/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/last_minute_holidays/maldives/affordable_luxury/oblu_nature/SidebarRight";
import ReviewProgress from "@/components/city-hotels/last_minute_holidays/maldives/affordable_luxury/oblu_nature/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/last_minute_holidays/maldives/affordable_luxury/oblu_nature/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/last_minute_holidays/maldives/affordable_luxury/oblu_nature/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/last_minute_holidays/maldives/affordable_luxury/oblu_nature/GalleryCruiseSlider";
...
export const metadata = {
  title: "Oblu Nature All Inclusive Package | Halo Holidays",
  description: "Embrace eco-luxury at Oblu Nature! Sustainable adventures, organic dining, and stunning marine life await.",
};

const oblu_nature = () => {
  const title = "OBLU NATURE Helengeli by SENTIDO";
...
export default dynamic(() => Promise.resolve(oblu_nature), {
  ssr: false,
});
