...
import Hotels from "@/components/hotels/common/turkey/LM_Turkey_Hotels";
...
import Maldives_cities from "@/components/holidays/last_minute_holidays/cities/turkey_cities";

export const metadata = {
  title: "Last Minute Holidays to Turkey | Halo Holidays",
  description: "Craving an adventure? Book your dream last-minute trip to Turkey with Halo Holidays.",
};
      ...
      <section className="layout-pt-md layout-pb-md">
        <div className="container">
          <div className="row y-gap-20 justify-between items-end">
            <div className="col-auto">
              <div className="sectionTitle -md">
                <h2 className="sectionTitle__title">Last Minute Hotels in Turkey</h2>
                <p className=" sectionTitle__text mt-5 sm:mt-0">
