...
import Hotels from "@/components/hotels/common/turkey/C_Turkey_Hotels";
import Hotels2 from "@/components/hotels/common/AI_Turkey_Hotels";
...
import Maldives_cities from "@/components/holidays/couple_holidays/cities/turkey_cities";

export const metadata = {
  title: "Couple Holidays to Turkey | Halo Holidays",
  description: "Plan a romantic Turkish getaway. Discover historic sites, stunning coastlines, and luxurious couple-focused resorts with Halo Holidays.",
};
      ...
      <section className="layout-pt-md layout-pb-md">
        <div className="container">
          <div className="row y-gap-20 justify-between items-end">
            <div className="col-auto">
              <div className="sectionTitle -md">
                <h2 className="sectionTitle__title">Couple Hotels in Turkey</h2>
                <p className=" sectionTitle__text mt-5 sm:mt-0">
