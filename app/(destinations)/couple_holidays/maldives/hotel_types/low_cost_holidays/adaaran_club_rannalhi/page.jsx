...
import Overview from "@/components/city-hotels/couple_holidays/maldives/low_cost_holidays/adaaran_club_rannalhi/Overview";
import TopBreadCrumb from "@/components/city-hotels/couple_holidays/maldives/low_cost_holidays/adaaran_club_rannalhi/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/couple_holidays/maldives/low_cost_holidays/adaaran_club_rannalhi/SidebarRight";
import ReviewProgress from "@/components/city-hotels/couple_holidays/maldives/low_cost_holidays/adaaran_club_rannalhi/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/couple_holidays/maldives/low_cost_holidays/adaaran_club_rannalhi/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/couple_holidays/maldives/low_cost_holidays/adaaran_club_rannalhi/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/couple_holidays/maldives/low_cost_holidays/adaaran_club_rannalhi/GalleryCruiseSlider";
...
export const metadata = {
  title: "Adaaran Club Rannalhi Laid-Back Couples | Halo Holidays",
  description: "Adaaran Club Rannalhi: Experience laid-back island charm without breaking the bank. Unwind on pristine shores with Halo Holidays.",
};
