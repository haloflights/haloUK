...
import Hotels from "@/components/hotels/common/maldives/C_M_Hotels";
import Hotels2 from "@/components/hotels/common/AI_M_Hotels";
...
import Maldives_cities from "@/components/holidays/couple_holidays/cities/maldives_cities";

export const metadata = {
  title: "Couple Holidays to Maldives | Halo Holidays",
  description: "Experience a romantic Maldivian escape! Find luxurious overwater villas and unforgettable experiences for couples with Halo Holidays.",
};
      ...
      <section className="layout-pt-md layout-pb-md">
        <div className="container">
          <div className="row y-gap-20 justify-between items-end">
            <div className="col-auto">
              <div className="sectionTitle -md">
                <h2 className="sectionTitle__title">Couple Hotels in Maldives</h2>
                <p className=" sectionTitle__text mt-5 sm:mt-0">
