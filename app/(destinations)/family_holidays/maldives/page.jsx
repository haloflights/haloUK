...
import Hotels from "@/components/hotels/common/maldives/F_M_Hotels";
...
import Maldives_cities from "@/components/holidays/family_holidays/cities/maldives_cities";

export const metadata = {
  title: "Family Holidays to Maldives | Halo Holidays",
  description: "Create unforgettable family memories in the Maldives! Find luxurious resorts and child-friendly activities with Halo Holidays.",
};
      ...
      <section className="layout-pt-md layout-pb-md">
        <div className="container">
          <div className="row y-gap-20 justify-between items-end">
            <div className="col-auto">
              <div className="sectionTitle -md">
                <h2 className="sectionTitle__title">Family Hotels in Maldives</h2>
                <p className=" sectionTitle__text mt-5 sm:mt-0">
