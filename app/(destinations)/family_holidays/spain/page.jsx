...
import Hotels from "@/components/hotels/common/spain/F_Spain_Hotels";
...
import Maldives_cities from "@/components/holidays/family_holidays/cities/spain_cities";

export const metadata = {
  title: "Family Holidays to Spain | Halo Holidays",
  description: "Experience the perfect family holiday in Spain. Find sunshine, kid-friendly resorts, and incredible deals with Halo Holidays.",
};
      ...
      <section className="layout-pt-md layout-pb-md">
        <div className="container">
          <div className="row y-gap-20 justify-between items-end">
            <div className="col-auto">
              <div className="sectionTitle -md">
                <h2 className="sectionTitle__title">Family Hotels in Spain</h2>
                <p className=" sectionTitle__text mt-5 sm:mt-0">
