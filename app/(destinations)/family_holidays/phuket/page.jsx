...
import Hotels from "@/components/hotels/common/phuket/F_Phuket_Hotels";
...
import Maldives_cities from "@/components/holidays/family_holidays/cities/phuket_cities";

export const metadata = {
  title: "Family Holidays to Phuket | Halo Holidays",
  description: "Discover family-friendly Phuket! Enjoy pristine beaches, exciting activities, and amazing resorts with Halo Holidays.",
};
      ...
      <section className="layout-pt-md layout-pb-md">
        <div className="container">
          <div className="row y-gap-20 justify-between items-end">
            <div className="col-auto">
              <div className="sectionTitle -md">
                <h2 className="sectionTitle__title">Family Hotels in Phuket</h2>
                <p className=" sectionTitle__text mt-5 sm:mt-0">
