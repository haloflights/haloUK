...
import Hotels from "@/components/hotels/common/turkey/B_Turkey_Hotels";
...
import Maldives_cities from "@/components/holidays/beach_holidays/cities/turkey_cities";

export const metadata = {
  title: "Beach Holidays to Turkey | Halo Holidays",
  description: "Find your perfect Turkish beach escape! Explore the beautiful coast, enjoy water sports, and relax in luxurious resorts.",
};
      ...
      <section className="layout-pt-md layout-pb-md">
        <div className="container">
          <div className="row y-gap-20 justify-between items-end">
            <div className="col-auto">
              <div className="sectionTitle -md">
                <h2 className="sectionTitle__title">Beach Hotels in Turkey</h2>
                <p className=" sectionTitle__text mt-5 sm:mt-0">
