...
import Hotels from "@/components/hotels/common/maldives/B_M_Hotels";
...
import Maldives_cities from "@/components/holidays/beach_holidays/cities/maldives_cities";

export const metadata = {
  title: "Beach Holidays to Maldives | Halo Holidays",
  description: "Experience paradise! Discover stunning Maldives beaches, luxurious resorts, and unforgettable water activities.",
};
      ...
      <section className="layout-pt-md layout-pb-md">
        <div className="container">
          <div className="row y-gap-20 justify-between items-end">
            <div className="col-auto">
              <div className="sectionTitle -md">
                <h2 className="sectionTitle__title">Beach Hotels in Maldives</h2>
                <p className=" sectionTitle__text mt-5 sm:mt-0">
