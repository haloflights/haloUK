...
import Overview from "@/components/city-hotels/beach_holidays/maldives/couples_adults_only/centara_ras_fushi/Overview";
import TopBreadCrumb from "@/components/city-hotels/beach_holidays/maldives/couples_adults_only/centara_ras_fushi/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/beach_holidays/maldives/couples_adults_only/centara_ras_fushi/SidebarRight";
import ReviewProgress from "@/components/city-hotels/beach_holidays/maldives/couples_adults_only/centara_ras_fushi/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/beach_holidays/maldives/couples_adults_only/centara_ras_fushi/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/beach_holidays/maldives/couples_adults_only/centara_ras_fushi/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/beach_holidays/maldives/couples_adults_only/centara_ras_fushi/GalleryCruiseSlider";
...
export const metadata = {
  title: "Centara Ras Fushi Adults-Only Beaches | Halo Holidays",
  description: "Centara Ras Fushi: Escape to an adults-only sanctuary, relax on idyllic beaches, and indulge in a romantic retreat with Halo Holidays.",
};

const centara_ras_fushi = () => {
  const title = "Centara Ras Fushi Resort & Spa";
...
export default dynamic(() => Promise.resolve(centara_ras_fushi), {
  ssr: false,
});
