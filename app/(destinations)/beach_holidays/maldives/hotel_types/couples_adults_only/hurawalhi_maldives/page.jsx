...
import Overview from "@/components/city-hotels/beach_holidays/maldives/couples_adults_only/hurawalhi_maldives/Overview";
import TopBreadCrumb from "@/components/city-hotels/beach_holidays/maldives/couples_adults_only/hurawalhi_maldives/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/beach_holidays/maldives/couples_adults_only/hurawalhi_maldives/SidebarRight";
import ReviewProgress from "@/components/city-hotels/beach_holidays/maldives/couples_adults_only/hurawalhi_maldives/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/beach_holidays/maldives/couples_adults_only/hurawalhi_maldives/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/beach_holidays/maldives/couples_adults_only/hurawalhi_maldives/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/beach_holidays/maldives/couples_adults_only/hurawalhi_maldives/GalleryCruiseSlider";
...
export const metadata = {
  title: "Hurawalhi Maldives Romantic Beach Getaway | Halo Holidays",
  description: "Hurawalhi Maldives: Indulge in a luxurious adults-only getaway. Discover stunning villas, romantic sunsets, and create intimate moments with Halo Holidays.",
};
