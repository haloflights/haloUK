...
import Overview from "@/components/city-hotels/beach_holidays/maldives/low_cost_holidays/adaaran_club_rannalhi/Overview";
import TopBreadCrumb from "@/components/city-hotels/beach_holidays/maldives/low_cost_holidays/adaaran_club_rannalhi/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/beach_holidays/maldives/low_cost_holidays/adaaran_club_rannalhi/SidebarRight";
import ReviewProgress from "@/components/city-hotels/beach_holidays/maldives/low_cost_holidays/adaaran_club_rannalhi/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/beach_holidays/maldives/low_cost_holidays/adaaran_club_rannalhi/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/beach_holidays/maldives/low_cost_holidays/adaaran_club_rannalhi/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/beach_holidays/maldives/low_cost_holidays/adaaran_club_rannalhi/GalleryCruiseSlider";
...
export const metadata = {
  title: "Adaaran Club Rannalhi Low Cost Holidays Beach Holidays | Halo Holidays",
  description: "Unwind on pristine shores without breaking the bank. Discover Adaaran Club Rannalhi's laid-back island charm.",
};
