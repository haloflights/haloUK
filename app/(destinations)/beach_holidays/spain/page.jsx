...
import Hotels from "@/components/hotels/common/spain/B_Spain_Hotels";
...
import Maldives_cities from "@/components/holidays/beach_holidays/cities/spain_cities";

export const metadata = {
  title: "Beach Holidays to Spain | Halo Holidays",
  description: "Explore Spain's stunning coastline! Discover vibrant beach towns, hidden coves, and enjoy the perfect beach holiday.",
};
      ...
      <section className="layout-pt-md layout-pb-md">
        <div className="container">
          <div className="row y-gap-20 justify-between items-end">
            <div className="col-auto">
              <div className="sectionTitle -md">
                <h2 className="sectionTitle__title">Beach Hotels in Spain</h2>
                <p className=" sectionTitle__text mt-5 sm:mt-0">
