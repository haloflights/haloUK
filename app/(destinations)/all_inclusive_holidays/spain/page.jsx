...
import Hotels from "@/components/hotels/common/AI_Spain_Hotels";
import Hotels2 from "@/components/hotels/common/spain/C_Spain_Hotels";
...
import MaldivesHero from "@/components/hero/all-inclusive-hero/spain-hero";
import Maldives_cities from "@/components/holidays/all_inclusive_holidays/cities/spain_cities";

export const metadata = {
  title: "All Inclusive Holidays to Spain | Halo Holidays",
  description: "Your perfect all-inclusive Spain holiday awaits! Enjoy sunshine, beaches, culture, and fantastic deals with Halo Holidays.",
};
      ...
      <section className="layout-pt-md layout-pb-md">
        <div className="container">
          <div className="row y-gap-20 justify-between items-end">
            <div className="col-auto">
              <div className="sectionTitle -md">
                <h2 className="sectionTitle__title">All Inclusive Hotels in Spain</h2>
                <p className=" sectionTitle__text mt-5 sm:mt-0">
      ...
      <section className="layout-pt-md layout-pb-md">
        <div className="container">
          <div className="row y-gap-20 justify-between items-end">
            <div className="col-auto">
              <div className="sectionTitle -md">
                <h2 className="sectionTitle__title">Couple Hotels in Spain</h2>
                <p className=" sectionTitle__text mt-5 sm:mt-0">
