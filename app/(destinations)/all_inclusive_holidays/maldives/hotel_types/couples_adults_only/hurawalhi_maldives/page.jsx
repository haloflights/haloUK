...
import Overview from "@/components/city-hotels/all_inclusive_holidays/maldives/couples_adults_only/hurawalhi_maldives/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/maldives/couples_adults_only/hurawalhi_maldives/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/maldives/couples_adults_only/hurawalhi_maldives/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/maldives/couples_adults_only/hurawalhi_maldives/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/maldives/couples_adults_only/hurawalhi_maldives/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/maldives/couples_adults_only/hurawalhi_maldives/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/maldives/couples_adults_only/hurawalhi_maldives/GalleryCruiseSlider";
...
export const metadata = {
  title: "Hurawalhi Maldives Couples Adults Only All Inclusive Holidays | Halo Holidays",
  description: "Celebrate your love in a tropical haven. Find your perfect couples' retreat at Hurawalhi Maldives with all-inclusive indulgences.",
};

const hurawalhi_maldives = () => {
  const title = "Hurawalhi Maldives";
...
export default dynamic(() => Promise.resolve(hurawalhi_maldives), {
  ssr: false,
});
