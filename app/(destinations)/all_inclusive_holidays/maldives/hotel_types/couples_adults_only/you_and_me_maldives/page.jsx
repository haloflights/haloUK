...
import Overview from "@/components/city-hotels/all_inclusive_holidays/maldives/couples_adults_only/you_and_me_maldives/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/maldives/couples_adults_only/you_and_me_maldives/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/maldives/couples_adults_only/you_and_me_maldives/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/maldives/couples_adults_only/you_and_me_maldives/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/maldives/couples_adults_only/you_and_me_maldives/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/maldives/couples_adults_only/you_and_me_maldives/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/maldives/couples_adults_only/you_and_me_maldives/GalleryCruiseSlider";
...
export const metadata = {
  title: "You and Me Maldives Couples Adults Only All Inclusive Holidays | Halo Holidays",
  description: "Romance awaits! Book your idyllic couples' escape to You & Me Maldives, an adults-only, all-inclusive paradise.",
};

const you_and_me_maldives = () => {
  const title = "You & Me Maldives";
...
export default dynamic(() => Promise.resolve(you_and_me_maldives), {
  ssr: false,
});
