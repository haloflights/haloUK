...
import Overview from "@/components/city-hotels/all_inclusive_holidays/maldives/couples_adults_only/robinson_club_maldives/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/maldives/couples_adults_only/robinson_club_maldives/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/maldives/couples_adults_only/robinson_club_maldives/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/maldives/couples_adults_only/robinson_club_maldives/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/maldives/couples_adults_only/robinson_club_maldives/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/maldives/couples_adults_only/robinson_club_maldives/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/maldives/couples_adults_only/robinson_club_maldives/GalleryCruiseSlider";
...
export const metadata = {
  title: "Robinson Club Maldives Couples Adults Only All Inclusive Holidays | Halo Holidays",
  description: "Escape to an adults-only paradise. Discover romantic all-inclusive bliss at Robinson Club Maldives with Halo Holidays.",
};
