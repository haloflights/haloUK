...
import Overview from "@/components/city-hotels/all_inclusive_holidays/maldives/affordable_luxury/canareef_resort_maldives/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/maldives/affordable_luxury/canareef_resort_maldives/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/maldives/affordable_luxury/canareef_resort_maldives/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/maldives/affordable_luxury/canareef_resort_maldives/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/maldives/affordable_luxury/canareef_resort_maldives/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/maldives/affordable_luxury/canareef_resort_maldives/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/maldives/affordable_luxury/canareef_resort_maldives/GalleryCruiseSlider";
...
export const metadata = {
  title: "Canareef Resort Maldives Affordable Luxury All Inclusive Holidays | Halo Holidays",
  description: "The Maldives doesn't have to be exclusive. Enjoy Canareef's all-inclusive luxury without the luxury price tag.",
};
