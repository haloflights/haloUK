...
import Overview from "@/components/city-hotels/all_inclusive_holidays/maldives/luxury_resorts/fairmont_maldives_sirru/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/maldives/luxury_resorts/fairmont_maldives_sirru/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/maldives/luxury_resorts/fairmont_maldives_sirru/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/maldives/luxury_resorts/fairmont_maldives_sirru/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/maldives/luxury_resorts/fairmont_maldives_sirru/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/maldives/luxury_resorts/fairmont_maldives_sirru/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/maldives/luxury_resorts/fairmont_maldives_sirru/GalleryCruiseSlider";
...
export const metadata = {
  title: "Fairmont Maldives Sirru Luxury Resorts All Inclusive Holidays | Halo Holidays",
  description: "Escape to Fairmont Maldives, where pristine shores meet unparalleled luxury. Experience all-inclusive bliss.",
};
