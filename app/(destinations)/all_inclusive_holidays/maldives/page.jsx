...
import Hotels from "@/components/hotels/common/AI_M_Hotels";
import Hotels2 from "@/components/hotels/common/maldives/H_M_Hotels";
...
import Maldives_cities from "@/components/holidays/all_inclusive_holidays/cities/maldives_cities";

export const metadata = {
  title: "All Inclusive Holidays to Maldives | Halo Holidays",
  description: "Experience paradise! Discover amazing all-inclusive Maldives holidays with Halo Holidays. Book your dream escape today.",
};
      ...
      <section className="layout-pt-md layout-pb-md">
        <div className="container">
          <div className="row y-gap-20 justify-between items-end">
            <div className="col-auto">
              <div className="sectionTitle -md">
                <h2 className="sectionTitle__title">All Inclusive Hotels in Maldives</h2>
                <p className=" sectionTitle__text mt-5 sm:mt-0">
      ...
      <section className="layout-pt-md layout-pb-md">
        <div className="container">
          <div className="row y-gap-20 justify-between items-end">
            <div className="col-auto">
              <div className="sectionTitle -md">
                <h2 className="sectionTitle__title">Honeymoon Hotels in Maldives</h2>
                <p className=" sectionTitle__text mt-5 sm:mt-0">
