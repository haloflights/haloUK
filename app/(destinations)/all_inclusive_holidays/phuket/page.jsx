...
import Hotels from "@/components/hotels/common/AI_Phuket_Hotels";
import Hotels2 from "@/components/hotels/common/phuket/B_Phuket_Hotels";
...
import Maldives_cities from "@/components/holidays/all_inclusive_holidays/cities/phuket_cities";

export const metadata = {
  title: "All Inclusive Holidays to Phuket | Halo Holidays",
  description: "Find your perfect all-inclusive Phuket escape. Explore stunning beaches, delicious food, and luxury resorts with Halo Holidays.",
};
      ...
      <section className="layout-pt-md layout-pb-md">
        <div className="container">
          <div className="row y-gap-20 justify-between items-end">
            <div className="col-auto">
              <div className="sectionTitle -md">
                <h2 className="sectionTitle__title">Beach Hotels in Phuket</h2>
                <p className=" sectionTitle__text mt-5 sm:mt-0">
