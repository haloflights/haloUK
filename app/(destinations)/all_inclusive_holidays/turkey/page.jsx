...
import Hotels from "@/components/hotels/common/AI_Turkey_Hotels";
import Hotels2 from "@/components/hotels/common/turkey/F_Turkey_Hotels";
...
import MaldivesHero from "@/components/hero/all-inclusive-hero/turkey-hero";
import Maldives_cities from "@/components/holidays/all_inclusive_holidays/cities/turkey_cities";

export const metadata = {
  title: "All Inclusive Holidays to Turkey | Halo Holidays",
  description: "Discover incredible all-inclusive holidays to Turkey. Explore vibrant culture, beautiful beaches & great value with Halo Holidays.",
};
      ...
      <section className="layout-pt-md layout-pb-md">
        <div className="container">
          <div className="row y-gap-20 justify-between items-end">
            <div className="col-auto">
              <div className="sectionTitle -md">
                <h2 className="sectionTitle__title">All Inclusive Hotels in Turkey</h2>
                <p className=" sectionTitle__text mt-5 sm:mt-0">
      ...
      <section className="layout-pt-md layout-pb-md">
        <div className="container">
          <div className="row y-gap-20 justify-between items-end">
            <div className="col-auto">
              <div className="sectionTitle -md">
                <h2 className="sectionTitle__title">Family Hotels in Turkey</h2>
                <p className=" sectionTitle__text mt-5 sm:mt-0">
