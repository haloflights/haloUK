...
import Hotels from "@/components/hotels/common/maldives/L_M_Hotels";
...
import Maldives_cities from "@/components/holidays/luxury_holidays/cities/maldives_cities";

export const metadata = {
  title: "Luxury Holidays to Maldives | Halo Holidays",
  description: "Discover the ultimate in luxury with a Maldives getaway. Pristine beaches, world-class resorts, and unforgettable experiences await.",
};
      ...
      <section className="layout-pt-md layout-pb-md">
        <div className="container">
          <div className="row y-gap-20 justify-between items-end">
            <div className="col-auto">
              <div className="sectionTitle -md">
                <h2 className="sectionTitle__title">Luxury Hotels in Maldives</h2>
                <p className=" sectionTitle__text mt-5 sm:mt-0">
