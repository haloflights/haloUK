...
import Hotels from "@/components/hotels/common/spain/L_Spain_Hotels";
...
import Maldives_cities from "@/components/holidays/luxury_holidays/cities/spain_cities";

export const metadata = {
  title: "Luxury Holidays to Spain | Halo Holidays",
  description: "Explore Spain in style! Discover chic hotels, Michelin-starred dining, and stunning cultural experiences with our luxury holidays.",
};
      ...
      <section className="layout-pt-md layout-pb-md">
        <div className="container">
          <div className="row y-gap-20 justify-between items-end">
            <div className="col-auto">
              <div className="sectionTitle -md">
                <h2 className="sectionTitle__title">Luxury Hotels in Spain</h2>
                <p className=" sectionTitle__text mt-5 sm:mt-0">
