...
import Hotels from "@/components/hotels/common/phuket/L_Phuket_Hotels";
...
import Maldives_cities from "@/components/holidays/luxury_holidays/cities/phuket_cities";

export const metadata = {
  title: "Luxury Holidays to Phuket | Halo Holidays",
  description: "Experience luxurious Phuket! Enjoy exclusive resorts, private beaches, and indulge in world-class dining and wellness.",
};
      ...
      <section className="layout-pt-md layout-pb-md">
        <div className="container">
          <div className="row y-gap-20 justify-between items-end">
            <div className="col-auto">
              <div className="sectionTitle -md">
                <h2 className="sectionTitle__title">Luxury Hotels in Phuket</h2>
                <p className=" sectionTitle__text mt-5 sm:mt-0">
