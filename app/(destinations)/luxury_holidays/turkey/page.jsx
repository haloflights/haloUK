...
import Hotels from "@/components/hotels/common/turkey/L_Turkey_Hotels";
...
import Maldives_cities from "@/components/holidays/luxury_holidays/cities/turkey_cities";

export const metadata = {
  title: "Luxury Holidays to Turkey | Halo Holidays",
  description: "Experience Turkish luxury! Find opulent resorts, personalized service, and immerse yourself in rich history and culture.",
};
      ...
      <section className="layout-pt-md layout-pb-md">
        <div className="container">
          <div className="row y-gap-20 justify-between items-end">
            <div className="col-auto">
              <div className="sectionTitle -md">
                <h2 className="sectionTitle__title">Luxury Hotels in Turkey</h2>
                <p className=" sectionTitle__text mt-5 sm:mt-0">
