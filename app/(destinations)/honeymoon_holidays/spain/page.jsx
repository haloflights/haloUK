...
import Hotels from "@/components/hotels/common/spain/H_Spain_Hotels";
...
import Maldives_cities from "@/components/holidays/honeymoon_holidays/cities/spain_cities";

export const metadata = {
  title: "Spain Honeymoon Holidays | Halo Holidays",
  description: "Find your perfect honeymoon in Spain. Enjoy vibrant cities, romantic beaches, and unforgettable getaways.",
};
      ...
      <section className="layout-pt-md layout-pb-md">
        <div className="container">
          <div className="row y-gap-20 justify-between items-end">
            <div className="col-auto">
              <div className="sectionTitle -md">
                <h2 className="sectionTitle__title">Honeymoon Hotels in Spain</h2>
                <p className=" sectionTitle__text mt-5 sm:mt-0">
