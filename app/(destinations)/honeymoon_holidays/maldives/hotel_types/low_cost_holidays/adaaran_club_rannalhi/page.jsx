...
import Overview from "@/components/city-hotels/honeymoon_holidays/maldives/low_cost_holidays/adaaran_club_rannalhi/Overview";
import TopBreadCrumb from "@/components/city-hotels/honeymoon_holidays/maldives/low_cost_holidays/adaaran_club_rannalhi/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/honeymoon_holidays/maldives/low_cost_holidays/adaaran_club_rannalhi/SidebarRight";
import ReviewProgress from "@/components/city-hotels/honeymoon_holidays/maldives/low_cost_holidays/adaaran_club_rannalhi/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/honeymoon_holidays/maldives/low_cost_holidays/adaaran_club_rannalhi/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/honeymoon_holidays/maldives/low_cost_holidays/adaaran_club_rannalhi/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/honeymoon_holidays/maldives/low_cost_holidays/adaaran_club_rannalhi/GalleryCruiseSlider";
...
export const metadata = {
  title: "Adaaran Club Rannalhi: Budget-Friendly Maldives Escape | Halo Holidays",
  description: "Who says paradise has to be pricey? Experience the Maldives on a budget at Adaaran Club Rannalhi.",
};
