...
import Overview from "@/components/city-hotels/honeymoon_holidays/maldives/affordable_luxury/sun_siyam_olhuveli_maldives/Overview";
import TopBreadCrumb from "@/components/city-hotels/honeymoon_holidays/maldives/affordable_luxury/sun_siyam_olhuveli_maldives/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/honeymoon_holidays/maldives/affordable_luxury/sun_siyam_olhuveli_maldives/SidebarRight";
import ReviewProgress from "@/components/city-hotels/honeymoon_holidays/maldives/affordable_luxury/sun_siyam_olhuveli_maldives/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/honeymoon_holidays/maldives/affordable_luxury/sun_siyam_olhuveli_maldives/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/honeymoon_holidays/maldives/affordable_luxury/sun_siyam_olhuveli_maldives/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/honeymoon_holidays/maldives/affordable_luxury/sun_siyam_olhuveli_maldives/GalleryCruiseSlider";
...
export const metadata = {
  title: "Sun Siyam Olhuveli Maldives: Vibrant Luxury for Less | Halo Holidays",
  description: "Get those amazing Maldives vibes without breaking the bank. Sun Siyam Olhuveli delivers luxury and fun.",
};
