...
import Hotels from "@/components/hotels/common/phuket/H_Phuket_Hotels";
...
import Maldives_cities from "@/components/holidays/honeymoon_holidays/cities/phuket_cities";

export const metadata = {
  title: "Phuket Honeymoon Holidays | Halo Holidays",
  description: "Discover romantic Phuket! Explore secluded beaches, indulge in couple's spa treatments, and create lasting memories.",
};
      ...
      <section className="layout-pt-md layout-pb-md">
        <div className="container">
          <div className="row y-gap-20 justify-between items-end">
            <div className="col-auto">
              <div className="sectionTitle -md">
                <h2 className="sectionTitle__title">Honeymoon Hotels in Phuket</h2>
                <p className=" sectionTitle__text mt-5 sm:mt-0">
