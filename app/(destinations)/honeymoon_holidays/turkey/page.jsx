...
import Hotels from "@/components/hotels/common/turkey/H_Turkey_Hotels";
...
import Maldives_cities from "@/components/holidays/honeymoon_holidays/cities/turkey_cities";

export const metadata = {
  title: "Turkey Honeymoon Holidays | Halo Holidays",
  description: "Plan a romantic Turkish honeymoon. Discover historic sites, stunning coastlines, and luxurious couple-focused resorts.",
};
      ...
      <section className="layout-pt-md layout-pb-md">
        <div className="container">
          <div className="row y-gap-20 justify-between items-end">
            <div className="col-auto">
              <div className="sectionTitle -md">
                <h2 className="sectionTitle__title">Honeymoon Hotels in Turkey</h2>
                <p className=" sectionTitle__text mt-5 sm:mt-0">
