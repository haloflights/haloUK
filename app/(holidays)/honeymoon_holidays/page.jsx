...
import Hotels2 from "@/components/hotels/common/C_Hotels";
export const metadata = {
    title: "Unforgettable Honeymoon Holidays | Halo Holidays",
    description: "From tropical beaches to romantic cities, find your dream honeymoon destination with Halo Holidays. Book your unforgettable escape today.",
  };
          ...
          <div className="row y-gap-20 justify-between items-end">
            <div className="col-auto">
              <div className="sectionTitle -md">
                ...
                <p className=" sectionTitle__text mt-5 sm:mt-0">
                Where love and luxury meet. Experience all-inclusive bliss at the world's most romantic destinations
                </p>
              </div>
            </div>
            {/* End .col */}
      ...
      <section className="layout-pt-md layout-pb-md">
        <div className="container">
          <div className="row y-gap-20 justify-between items-end">
            <div className="col-auto">
              <div className="sectionTitle -md">
                <h2 className="sectionTitle__title">Top All-Inclusive Resorts for Blissful Honeymoons</h2>
                <p className=" sectionTitle__text mt-5 sm:mt-0">
                From Private Plunge Pools to Gourmet Feasts, Your All-Inclusive Honeymoon Starts Here
                </p>
              </div>
            </div>
            {/* End .col */}
      ...
      <section className="layout-pt-md layout-pb-md">
        <div className="container">
          <div className="row y-gap-20 justify-between items-end">
            <div className="col-auto">
              <div className="sectionTitle -md">
                <h2 className="sectionTitle__title">All-Inclusive Honeymoon Resorts for Couples</h2>
                <p className=" sectionTitle__text mt-5 sm:mt-0">
                Immerse yourselves in exquisite comfort. All-inclusive honeymoon resorts designed for pure indulgence
                </p>
              </div>
            </div>
            {/* End .col */}
