...
import Hotels from "@/components/hotels/common/L_Hotels";
import Hotels2 from "@/components/hotels/common/LM_Hotels";
import TrustBox from "@/components/trustpilot/page";

export const metadata = {
    title: "Luxury Holidays | Experience the Finest | Halo Holidays",
    description: "Indulge in pure luxury. Discover our curated collection of upscale holidays with exquisite resorts and personalized service.",
  };
          ...
          <div className="row y-gap-20 justify-between items-end">
            <div className="col-auto">
              <div className="sectionTitle -md">
                ...
                <p className=" sectionTitle__text mt-5 sm:mt-0">
                Immerse yourself in endless luxury. All-inclusive dreamscapes
                </p>
              </div>
            </div>
            {/* End .col */}
      ...
      <section className="layout-pt-md layout-pb-md">
        <div className="container">
          <div className="row y-gap-20 justify-between items-end">
            <div className="col-auto">
              <div className="sectionTitle -md">
                <h2 className="sectionTitle__title">All Inclusive Luxury Hotels & Resorts</h2>
                <p className=" sectionTitle__text mt-5 sm:mt-0">
                Immerse yourself in luxury, every moment yours
                </p>
              </div>
            </div>
            {/* End .col */}
      ...
      <section className="layout-pt-md layout-pb-md">
        <div className="container">
          <div className="row y-gap-20 justify-between items-end">
            <div className="col-auto">
              <div className="sectionTitle -md">
                <h2 className="sectionTitle__title">Last Minute Luxury Holidays</h2>
                <p className=" sectionTitle__text mt-5 sm:mt-0">
                Unwind in opulence. Where serendipity meets five-star service
                </p>
              </div>
            </div>
            {/* End .col */}
